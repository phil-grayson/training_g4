...
outfile=$(echo $3 | sed 's/,/\n/g' | head -1)

python /home/pgrayson/programs/Platypus/bin/Platypus.py callVariants --verbosity=3 --bufferSize=50000 --nCPU=24 --bamFiles=${1} --refFile=${2} --regions=${3} --output=${outfile}.vcf
